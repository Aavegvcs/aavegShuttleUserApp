...
import 'search_page_drop_model.dart';
export 'search_page_drop_model.dart';

class SearchPageDropWidget extends StatefulWidget {
  const SearchPageDropWidget({
    super.key,
  ...
  @override
  State<SearchPageDropWidget> createState() => _SearchPageDropWidgetState();
}

class _SearchPageDropWidgetState extends State<SearchPageDropWidget> {
  late SearchPageDropModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchPageDropModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (FFAppState().setLocation) {
        setState(() {
          _model.pickupLocationController?.text = FFAppState().pickupLocation;
        });
      } else {
        _model.apiResult1se = await LatLongLocationCall.call(
        ...
        if ((_model.apiResult1se?.succeeded ?? true)) {
          setState(() {
            _model.pickupLocationController?.text = getJsonField(
              (_model.apiResult1se?.jsonBody ?? ''),
                                ...
                                children: [
                                  ...
                                  FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return Builder(
                                        builder: (context) {
                                          final locationNames1 = LocationApiCall
                                                  .locationPrediction(
                                ...
                                children: [
                                  FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return Builder(
                                        builder: (context) {
                                          final locationNames2 = LocationApiCall
                                                  .locationPrediction(
                                                listViewLocationApiResponse
                                                    .jsonBody,
                                              )?.toList() ??
                                            ...
                                            itemBuilder:
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if (_model.pickupLocationController
                                                              .text ==
                                                          '') {
                                                    _model.latLongAPI =
                                                        await LatLongLocationCall
                                                            .call(
                                                      lat: functions
                                                          .getLatLong(
                                                              currentUserLocationValue!,
